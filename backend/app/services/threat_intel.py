...
from app.schemas.security import HighRiskIP, ThreatIntelItem, ThreatIntelResponse
...
def get_threat_intelligence() -> ThreatIntelResponse:
    return ThreatIntelResponse(
        latestThreats=[
            ThreatIntelItem(
                ...
                severity="critical",
                description=(
                    "Updated ransomware-as-a-service variant targeting enterprise Windows "
                    "environments via phishing and RDP brute force."
                ),
            ...
            ThreatIntelItem(
                ...
                severity="high",
                description=(
                    "Banking trojan resurfacing through malicious Office macros and "
                    "thread-hijacked email replies."
                ),
            ...
            ThreatIntelItem(
                ...
                type="botnet",
                severity="high",
                description="New C2 clusters observed distributing loaders for secondary payloads.",
